...
public class DeportistaDao {
	...
	public Deportista getDeportista(String id) throws Exception {
		...
		sql = "SELECT * FROM Deportista WHERE id_deportista = ?;";
	...
	public String crearDeportista(Deportista d) {
		...
		try {
			...
			ex.printStackTrace();
			msg+="Fallo al crear el Deportista";
		}
		return msg;
	}
	...
	public String editarDeportista(Deportista d) {
		...
		try {
			...
			ex.printStackTrace();
			msg = "Fallo al modificar el Deportista";
		}
		return msg;
	}
	...
	public void borrarDeportista(Deportista d) throws Exception {
		...
		sql = "DELETE FROM Participacion WHERE id_deportista = ?;";
		ps = con.prepareStatement(sql);
		ps.setString(1, d.getId_deportista());
		ps.executeUpdate();
	...
	public int verRepetidos(String nom) throws Exception {
		...
		try {
			...
			sql = "SELECT count(*) as respuesta FROM Deportista WHERE nombre = ? ;";
